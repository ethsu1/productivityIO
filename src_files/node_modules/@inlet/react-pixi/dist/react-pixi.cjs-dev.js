...
var withPixiApp = function withPixiApp(BaseComponent) {
  var wrapper = /*#__PURE__*/React__default.forwardRef(function (props, ref) {
...
var propTypes$1 = {
  ...
  options: propTypes.shape({
    ...
    resizeTo: function resizeTo(props, propName, componentName) {
      var el = props[propName];
      invariant_1(el !== window && !(el instanceof HTMLElement), "Invalid prop `resizeTo` of type ".concat(_typeof(el), ", expect `window` or an `HTMLElement`."));
    },
...
var hasAutoDensity = function hasAutoDensity(dens) {
  return dens !== false;
};
...
var Stage = /*#__PURE__*/function (_React$Component) {
  ...
  function Stage() {
    ...
    _defineProperty(_assertThisInitialized(_this), "updateSize", function () {
      ...
      if (hasAutoDensity(options === null || options === void 0 ? void 0 : options.autoDensity)) {
  ...
  _createClass(Stage, [{
    ...
    value: function componentDidMount() {
      ...
      if (hasAutoDensity(options === null || options === void 0 ? void 0 : options.autoDensity) && window.matchMedia && !(options === null || options === void 0 ? void 0 : options.resolution)) {
    ...
    value: function componentDidUpdate(prevProps, prevState, prevContext) {
      ...
      if ((options === null || options === void 0 ? void 0 : options.resolution) && (prevProps === null || prevProps === void 0 ? void 0 : prevProps.options.resolution) !== (options === null || options === void 0 ? void 0 : options.resolution)) {
    ...
    value: function resetInteractionManager() {
      ...
      this.app.renderer.plugins.interaction = new pixi_js.InteractionManager(this.app.renderer);
    }
  }, {
    key: "getChildren",
